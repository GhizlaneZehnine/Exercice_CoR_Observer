...
public class Main {
    ...
    public static void main(String[] args) {
        RequestHandler handler1 = new ExistingContentCheckRequestHandler();
        RequestHandler handler2 = new PolicyCheckRequestHandler();
        RequestHandler handler3 = new RenderContentHandler();

        handler1.setSuccessor(handler2);
        handler2.setSuccessor(handler3);
        WebServer webServer = new WebServer(handler1);
